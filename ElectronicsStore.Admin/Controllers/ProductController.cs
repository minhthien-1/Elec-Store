    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            try
            {
                ...
                {
                    ViewBag.ErrorMessage = "Không thể thêm sản phẩm!";
                    return View(product);
                }
            }
            catch (Exception ex)
        ...
        public async Task<IActionResult> Edit(Product product)
        {
            ...
            try
            {
                ...
                var apiUrl = _configuration["ApiSettings:BaseUrl"] + $"/api/product/{product.Id}";
                ...
                {
                    ViewBag.ErrorMessage = "Không thể cập nhật sản phẩm!";
                    return View(product);
                }
            }
            catch (Exception ex)
